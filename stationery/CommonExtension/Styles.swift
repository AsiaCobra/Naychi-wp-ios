...
public func rightCornerStyle(_ value: CGFloat) -> (UIView) -> Void {
    return {
        $0.layer.cornerRadius = value
...
public func colorCodedStyle(baseColor: UIColor, codedColor: UIColor, _ query: String) -> (UILabel) -> Void {
    return {
        ...
        attributedText.addAttributes([NSAttributedString.Key.foregroundColor: codedColor,.font: UIFont(name: "Sk-Modernist-Bold", size: 17.0)!], range: queryRange)
