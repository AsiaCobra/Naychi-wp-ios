...
protocol BrandItemDisplayLogic: AnyObject {
...
class BrandItemVC: BaseVC, Storyboarded {
    
    static var storyboardName: String = Constant.Storyboard.home
    
    var router: (NSObjectProtocol & BrandItemRoutingLogic)?
...
extension BrandItemVC: BrandItemDisplayLogic {
    func removeLoadMore() {
...
extension BrandItemVC: ItemCellProtocol {
...
extension BrandItemVC: CartDialogProtocol {
...
extension BrandItemVC: ItemHeaderProtocol {
...
extension BrandItemVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
